...
export default function RegisterPart() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      // unifica: nome da empresa como name e company_name
      ...
      cnpj: formData.cnpj,
      // garante compatibilidade com backends que variam a chave
      tipe_person: "juridico",
    ...
    try {
      ...
      toast.success(
        "Cadastro realizado com sucesso. Vamos avaliar as suas informações e entraremos em contato por email ou pelo telefone.",
        { duration: 6000 }
      );
      navigate("/parceiros");
    } catch (error) {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full bg-gray-200 min-h-screen pt-24 text-black px-6 ">
      ...
      >
        ...
        <p className="text-sm self-start mb-8">
          Para cadastrar como cliente clique{" "}
          <strong
            className="cursor-pointer text-red-700"
            onClick={handleClicClient}
          >
            aqui.
          </strong>
        </p>
        ...
        <div className="flex flex-col md:items-center items-start w-full gap-4">
          <div className="flex md:flex-row flex-col md:items-center md:gap-4 gap-2 w-full">
            <label className="w-44 md:text-right" htmlFor="email">
              Email
            </label>
            <input
              id="email"
          ...
          <div className="flex md:flex-row flex-col md:items-center md:gap-4 gap-2 w-full">
            <label className="w-44 md:text-right" htmlFor="telefone">
              Telefone
            </label>
            <input
              id="telefone"
        ...
        <p className="text-lg font-bold pt-2">Dados da Empresa</p>

        {/* Somente PJ */}
        <div className="flex flex-col md:items-center items-start w-full gap-4">
          <div className="flex md:flex-row flex-col md:items-center md:gap-4 gap-2 w-full">
            <label className="w-44 md:text-right" htmlFor="razao">
              Razão Social
            </label>
            <input
              id="razao"
          ...
          <div className="flex md:flex-row flex-col md:items-center md:gap-4 gap-2 w-full">
            <label className="w-44 md:text-right" htmlFor="CNPJ">
              CNPJ
            </label>
            <input
              id="CNPJ"
        ...
        <div className="flex flex-col md:items-center items-start w-full gap-4">
          <div className="flex md:flex-row flex-col md:items-center md:gap-4 gap-2 w-full">
            <label className="w-44 md:text-right" htmlFor="cep">
              CEP
            </label>
            <input
              id="cep"
          ...
          <div className="flex md:flex-row flex-col md:items-center md:gap-4 gap-2 w-full">
            <label className="w-44 md:text-right" htmlFor="endereco">
              Endereço
            </label>
            <input
              id="endereco"
          ...
          <div className="flex md:flex-row flex-col md:items-center md:gap-4 gap-2 w-full">
            <label className="w-44 md:text-right" htmlFor="numero">
              Número
            </label>
            <input
              id="numero"
          ...
          <div className="flex md:flex-row flex-col md:items-center md:gap-4 gap-2 w-full">
            <label className="w-44 md:text-right" htmlFor="compl">
              Complemento
            </label>
            <input
              id="compl"
          ...
          <div className="flex md:flex-row flex-col md:items-center md:gap-4 gap-2 w-full">
            <label className="w-44 md:text-right" htmlFor="bairro">
              Bairro
            </label>
            <input
              id="bairro"
          ...
          <div className="flex md:flex-row flex-col md:items-center md:gap-4 gap-2 w-full">
            <label className="w-44 md:text-right" htmlFor="cidade">
              Cidade
            </label>
            <input
              id="cidade"
          ...
          <div className="flex md:flex-row flex-col md:items-center md:gap-4 gap-2 w-full">
            <label className="w-44 md:text-right" htmlFor="estado">
              Estado
            </label>
            <select
              id="estado"
          ...
          <div className="flex md:flex-row flex-col md:items-center md:gap-4 gap-2 w-full">
            <label className="w-44 md:text-right" htmlFor="ref">
              Ponto de referência
            </label>
            <input
              id="ref"
