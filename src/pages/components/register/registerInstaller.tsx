  ...
  return (
    <div className="flex flex-col items-center justify-center w-full bg-gray-200 min-h-screen pt-24 text-black px-6 ">
      ...
      >
        ...
        <p className="text-sm self-start mb-8">Para cadastrar como cliente clique <strong className="cursor-pointer text-red-700" onClick={handleClicClient}>aqui.</strong></p>
