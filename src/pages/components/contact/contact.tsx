          ...
          <div className="flex flex-col items-center justify-center w-full gap-6 mt-8">
            <form className="flex flex-col items-center justify-center w-full gap-4 p-6">
              ...
              <div className="flex flex-col w-full">
                ...
                <textarea placeholder="Digite sua mensagem" className="p-2 border border-gray-300 rounded-md h-44 focus:outline-none focus:ring-1 focus:ring-black focus:border-black"></textarea>
              </div>
